...
basepath='C:\Users\dancu\Downloads\embody-master\embody-master\matlab\demo_subjects'; % folder where subjects are
subjects=dir([basepath '/*']);

% the base image used for painting (in our case only one sided since we
% subtract values)
base=uint8(imread('C:\Users\dancu\Downloads\embody-master\embody-master\matlab\base.png'));
base2=base(10:531,33:203,:); % single image base
labels={'Nada especial (neutral)'
'Miedo'
'Ira'
'Asco'
'Tristeza'
